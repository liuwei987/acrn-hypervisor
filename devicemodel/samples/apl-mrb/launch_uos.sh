...
modprobe pci_stub
echo ${passthru_vpid["vt_d"]} > /sys/bus/pci/drivers/pci-stub/new_id
echo ${passthru_bdf["vt_d"]} > /sys/bus/pci/devices/${passthru_bdf["vt_d"]}/driver/unbind
echo ${passthru_bdf["vt_d"]} > /sys/bus/pci/drivers/pci-stub/bind
