...
devicemodel: tools
	make -C $(T)/devicemodel DM_OBJDIR=$(DM_OUT) BOARD=$(BOARD) clean
	make -C $(T)/devicemodel DM_OBJDIR=$(DM_OUT) BOARD=$(BOARD) DM_BUILD_VERSION=$(BUILD_VERSION) DM_BUILD_TAG=$(BUILD_TAG)
